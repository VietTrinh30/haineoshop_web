...
import type { TabWithProducts } from './types'

type ProductListingCategoriesModeProps = {
  heading: string
  enableSearch?: boolean
  tabs: TabWithProducts[]
}

export const ProductListingCategoriesMode: React.FC<ProductListingCategoriesModeProps> = ({
  heading,
  enableSearch,
  tabs,
}) => {
