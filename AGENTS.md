...
This project is indexed by GitNexus as **daisy-flower-main** (2038 symbols, 3507 relationships, 18 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/daisy-flower-main/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/daisy-flower-main/context` | Codebase overview, check index freshness |
| `gitnexus://repo/daisy-flower-main/clusters` | All functional areas |
| `gitnexus://repo/daisy-flower-main/processes` | All execution flows |
| `gitnexus://repo/daisy-flower-main/process/{name}` | Step-by-step execution trace |
